...
const UsersDetail = () => {
  ...
  useEffect(() => {
    const fetchUserDetail = async () => {
      try {
        ...
        const response = await axios.get(`https://luckytang-server.onrender.com/api/users/userinfo/${id}`, {
    ...
    const fetchUserPoints = async () => {
      try {
        ...
        const response = await axios.get(`https://luckytang-server.onrender.com/api/points/${id}`, {
          headers: { Authorization: `Bearer ${token}` },
        });
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const response = await axios.delete(`https://luckytang-server.onrender.com/api/users/userinfo/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
